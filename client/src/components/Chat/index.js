        ...
        <ChatWrapper>
          <ChatHeader className="chat-header overlap-top">
            <HeaderLeft className="chat-header__left">
              <div className="chat-header__title">Channel Name</div>
              ...
              <div className="chat-view__content">
                <div className="chat-msg chat-msg--you">
                  <span className="chat-msg__text chat-msg__text--you">
                    ...
                    vel explicabo? Lorem ipsum dolor sit, amet consectetur adipisicing elit. Minima, voluptate placeat
                    ut minus vitae officiis, similique blanditiis quisquam id praesentium temporibus eos ex ab
                    repudiandae magnam consequuntur dolor vel unde. Lorem ipsum dolor sit amet consectetur adipisicing
                    elit. Totam, ducimus repudiandae. Beatae sequi iusto saepe tempore ipsam repellat veritatis quis
                    optio illo laborum quasi possimus, id quidem minus consectetur ipsa? Lorem ipsum dolor sit amet
                    consectetur adipisicing elit. Architecto, distinctio necessitatibus consequatur omnis at voluptas
                    dolor ratione, laudantium, quibusdam id perferendis asperiores veniam. Doloribus beatae nesciunt
                    repellat culpa ullam aspernatur!
                  </span>
                </div>
